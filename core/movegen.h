...
private:
  ...
  static void GetPawnMoves(const Position& position, const Square& square, std::vector<Move> *moves);
  static void GetPromotionMoves(const Position& position, const Square& start_square, const Square& end_square, std::vector<Move> *moves);
  static void GetKnightMoves(const Position& position, const Square& square, std::vector<Move> *moves);
  static void GetDiagonalMoves(const Position& position, const Square& square, bool limit_to_one, std::vector<Move> *moves);
  static void GetOrthogonalMoves(const Position& position, const Square& square, bool limit_to_one, std::vector<Move> *moves);
